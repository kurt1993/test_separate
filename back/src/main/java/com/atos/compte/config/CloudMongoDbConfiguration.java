package com.atos.compte.config;

import com.github.mongobee.Mongobee;
import com.mongodb.Mongo;
import com.atos.compte.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.atos.compte.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.atos.compte.config.dbmigrations");
